...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>频道幻灯</td><td bgcolor='ffffff'><input name="hdpic" type="text" id="hdpic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[hdpic]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=hdpic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a>  图看世界726*360
...
</div><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>cid</td><td bgcolor='ffffff'>
<input name="cid" type="text" id="cid" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[cid]))?>" size="120">
</td></tr></table>