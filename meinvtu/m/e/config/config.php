...
$ecms_config['db']['dbname']='mn131cn';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='www_92game_net_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='wMm6oU8INYf4W3aSVznPR7PVPwIEg9';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='ewvlq';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='sakwn';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='SvuMey2ED9B6OjNNRG077FrjncGZMH';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='dYBbg71spprbegwgHykQvbhX7f7aV0';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'mm131_图片大全',
'newsurl'=>'/',
'filetype'=>'|.gif|.jpg|.png|.rar|.zip|.mp3|.wmv|.txt|.doc|',
'filesize'=>2048,
'relistnum'=>8,
'renewsnum'=>10,
'min_keyboard'=>2,
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'TcAXpyxlUkaG90w7eJdHztkYTFzd5L',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/word/\">图看世界</a>&nbsp;|&nbsp;<a href=\"/ent/\">娱乐周边</a>&nbsp;|&nbsp;<a href=\"/e/action/ListInfo/?classid=11\">明星库</a>&nbsp;|&nbsp;<a href=\"/beautiful/\">唯美图片</a>&nbsp;|&nbsp;<a href=\"/game/\">游戏动漫</a>&nbsp;|&nbsp;<a href=\"/qita/\">其他图片</a>&nbsp;|&nbsp;<a href=\"/e/action/ListInfo/?classid=14\">广告位</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'modmemberedittran'=>0,
'modinfoedittran'=>0,
'deftempid'=>0,'add_www_92game_net_www'=>'','add_www_92game_net_shouji'=>'','add_www_92game_net_tishi'=>'更多美女图片下载: http://www.meinvla.cn','add_www_92game_net_file'=>'');
//------------e_public
...
'pname'=>'主访问端',
'purl'=>'/',
'ppath'=>'D:/wwwroot/meinvtu/wwwroot/',
'postpass'=>'pDp2SE3OY8fsKPz6jRsuu03MZASDsM5bgVu4hEFlddyI0AclRP2T1g7ndkYG',
'postfile'=>'',
'tempgid'=>'0',
'isclose'=>'0',
'closeadd'=>'0',
...
'pname'=>'mobile',
'purl'=>'',
'ppath'=>'D:/wwwroot/meinvtu/wwwroot/m/',
'postpass'=>'C2KGnuWxwQbsqT8cTC39PdCLNFJLVKxQlKFbqdGr0X8lEebP3JOdGUEsoeE4',
'postfile'=>'',
'tempgid'=>'2',
'isclose'=>'0',
'closeadd'=>'1',
...
'intb'=>0,
'mid'=>8);
$etable_r['star']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>9);
$etable_r['gg']=Array('deftb'=>'1',
'yhid'=>0,
'intb'=>0,
'mid'=>11);
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,hdpic,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,cid,',
'qenter'=>',title,ftitle,special.field,titlepic,smalltext,writer,befrom,newstext,',
'listtempf'=>',title,ftitle,hdpic,newstime,titlepic,smalltext,diggtop,cid,',
'tempf'=>',title,ftitle,hdpic,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,cid,',
'mustqenterf'=>',title,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,',
'canaddf'=>',title,ftitle,hdpic,newstime,titlepic,smalltext,writer,befrom,newstext,cid,',
'caneditf'=>',title,ftitle,hdpic,newstime,titlepic,smalltext,writer,befrom,newstext,cid,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,cid,hdpic,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,cid,hdpic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,cid,hdpic,gxhd,re1,re2,indexhd,indextj,titlepic,morepic,picsay,',
'qenter'=>',title,special.field,titlepic,picsay,',
'listtempf'=>',title,newstime,cid,hdpic,gxhd,re1,re2,indexhd,indextj,titlepic,picsay,',
'tempf'=>',title,newstime,cid,hdpic,gxhd,re1,re2,indexhd,indextj,titlepic,morepic,picsay,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,picsay,',
'cj'=>',title,newstime,titlepic,morepic,picsay,',
'canaddf'=>',title,newstime,cid,hdpic,gxhd,re1,re2,indexhd,indextj,titlepic,morepic,picsay,',
'caneditf'=>',title,newstime,cid,hdpic,gxhd,re1,re2,indexhd,indextj,titlepic,morepic,picsay,',
'tbmainf'=>',title,titlepic,newstime,picurl,picsay,cid,hdpic,gxhd,re1,re2,pdhd,indexhd,indextj,',
'tbdataf'=>',filesize,picsize,picfbl,picfrom,morepic,num,width,height,',
'tobrf'=>',picsay,',
'dohtmlf'=>',filesize,picsize,picfbl,picfrom,picurl,morepic,num,width,height,picsay,cid,hdpic,gxhd,re1,re2,pdhd,indexhd,indextj,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',',
'ubbeditorf'=>',',
...
'smalltextf'=>',picsay,',
'filef'=>',',
'imgf'=>',titlepic,picurl,hdpic,gxhd,re1,re2,pdhd,indexhd,indextj,',
'flashf'=>',',
'linkfields'=>'|',
'morevaluef'=>'|',
'onlyf'=>',',
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|3|4|5|7|10|12|13|17|18|20|22|23|25|26|29|30|31|33|34|35|36|',
'tid'=>3,
'tbname'=>'photo');
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'qenter'=>',',
'listtempf'=>',title,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'tempf'=>',title,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'mustqenterf'=>',title,',
'listandf'=>',diqu,xingbie,infozm,',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,',
'canaddf'=>',title,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'caneditf'=>',title,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'tbmainf'=>',title,titlepic,newstime,diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',diqu,xingbie,infozm,chusheng,guoji,xinxi,weixin,guanbi,bigbg,pic,grjs,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',',
'ubbeditorf'=>',',
...
'smalltextf'=>',',
'filef'=>',',
'imgf'=>',titlepic,weixin,bigbg,pic,',
'flashf'=>',',
'linkfields'=>'|',
'morevaluef'=>'|',
'onlyf'=>',',
...
'qenter'=>',',
'listtempf'=>',title,titlepic,newstime,',
'tempf'=>',title,titlepic,newstime,',
'mustqenterf'=>',title,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>'',
...
'tbmainf'=>',title,titlepic,newstime,',
'tbdataf'=>',',
'tobrf'=>',',
'dohtmlf'=>',',
'checkboxf'=>',',
