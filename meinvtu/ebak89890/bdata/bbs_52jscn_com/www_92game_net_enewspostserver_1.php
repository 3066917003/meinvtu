...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `www_92game_net_enewspostserver`;");
E_C("CREATE TABLE `www_92game_net_enewspostserver` (
...
E_D("replace into `www_92game_net_enewspostserver` values('1','附件服务器','','1','','','','','','0','0','0','0','0');");
