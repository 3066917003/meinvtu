...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `www_92game_net_enewspublic_update`;");
E_C("CREATE TABLE `www_92game_net_enewspublic_update` (
...
E_D("replace into `www_92game_net_enewspublic_update` values('1','1473593236','1355124476','66989','0','|3,51169|1,14320|9,392|','','1502875974','1502875974','0','0','0','0');");
