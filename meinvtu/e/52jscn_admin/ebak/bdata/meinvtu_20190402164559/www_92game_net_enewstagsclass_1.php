...
E_D("replace into `www_92game_net_enewstagsclass` values('5','犬类�\�');");
E_D("replace into `www_92game_net_enewstagsclass` values('6','动物类型');");
E_D("replace into `www_92game_net_enewstagsclass` values('7','猫类�\�');");
...
E_D("replace into `www_92game_net_enewstagsclass` values('12','鸟类�\�');");
E_D("replace into `www_92game_net_enewstagsclass` values('13','鼠类�\�');");
E_D("replace into `www_92game_net_enewstagsclass` values('14','鱼类�\�');");
...
E_D("replace into `www_92game_net_enewstagsclass` values('21','卡通类�\�');");
E_D("replace into `www_92game_net_enewstagsclass` values('22','非主流类�\�');");
