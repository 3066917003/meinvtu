...
E_D("replace into `www_92game_net_enewsad` values('6','','','468','60','0','1','1','pc内容�\� 960x200','','','2016-09-11','0000-00-00','','','','<div style=\"width:958px;height:198px;text-align: center;border:1px solid #ECECEC;line-height:198px;background-color: #fff;color: #333;font-family: 微软雅黑 Light;font-size: 20px;\">广告ID:6 960*200</div>','2','0','');");
E_D("replace into `www_92game_net_enewsad` values('7','','','468','60','0','1','1','pc内容�\� 960x60','','','2016-09-11','0000-00-00','','','','<div style=\"width:958px;height:58px;text-align: center;border:1px solid #ECECEC;line-height:58px;background-color: #fff;color: #333;font-family: 微软雅黑 Light;font-size: 20px;\">广告ID:7 960*60</div>','2','0','');");
...
E_D("replace into `www_92game_net_enewsad` values('11','','','468','60','0','1','1','手机版头部图文广�\�','','','2016-09-12','0000-00-00','','','','<div style=\"width:100%;height:88px;text-align: center;border:1px solid #ECECEC;line-height:88px;background-color: #fff;color: #333;font-family: 微软雅黑 Light;font-size: 20px;\">广告ID:11</div>','2','0','');");
E_D("replace into `www_92game_net_enewsad` values('12','','','468','60','0','1','1','手机版内页图片下�\�','','','2016-09-12','0000-00-00','','','','<div style=\"width:100%;height:88px;text-align: center;border:1px solid #ECECEC;line-height:88px;background-color: #fff;color: #333;font-family: 微软雅黑 Light;font-size: 20px;\">广告ID:12</div>','2','0','');");
E_D("replace into `www_92game_net_enewsad` values('13','','','468','60','0','1','1','移动下翻�\� 全站','','','2016-09-12','0000-00-00','','','','<div style=\"width:100%;height:88px;text-align: center;border:1px solid #ECECEC;line-height:88px;background-color: #fff;color: #333;font-family: 微软雅黑 Light;font-size: 20px;\">广告ID:13</div>','2','0','');");
...
E_D("replace into `www_92game_net_enewsad` values('15','','','468','60','0','1','1','m端悬�\�','','','2016-09-12','0000-00-00','','','','','2','0','');");
