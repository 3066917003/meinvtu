...
E_D("DROP TABLE IF EXISTS `www_92game_net_enewspl_set`;");
E_C("CREATE TABLE `www_92game_net_enewspl_set` (
...
E_D("replace into `www_92game_net_enewspl_set` values('1','20','500','0','1','||[~e.jy~]##1.gif||[~e.kq~]##2.gif||[~e.se~]##3.gif||[~e.sq~]##4.gif||[~e.lh~]##5.gif||[~e.ka~]##6.gif||[~e.hh~]##7.gif||[~e.ys~]##8.gif||[~e.ng~]##9.gif||[~e.ot~]##10.gif||','10','0','','','',',1,','1','12','1','/e/pl/','0','<div class=\\\\\"ecomment\\\\\">\r\n<span class=\\\\\"ecommentauthor\\\\\">网友 [!--username--] 的原文：</span>\r\n<p class=\\\\\"ecommenttext\\\\\">[!--pltext--]</p>\r\n</div>');");
