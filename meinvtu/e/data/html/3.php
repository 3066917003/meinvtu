...
<tr><td width='16%' height=25 bgcolor='ffffff'>首页幻灯</td><td bgcolor='ffffff'><input name="indexhd" type="text" id="indexhd" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[indexhd]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=indexhd<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 610*360
</td></tr>
<tr><td width='16%' height=25 bgcolor='ffffff'>频道幻灯</td><td bgcolor='ffffff'><input name="hdpic" type="text" id="hdpic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[hdpic]))?>" size="45">
...
<tr><td width='16%' height=25 bgcolor='ffffff'>栏目幻灯</td><td bgcolor='ffffff'><input name="gxhd" type="text" id="gxhd" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[gxhd]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=gxhd<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 风景图片380*225 搞笑栏目300*340  明星图片290*370 动漫图片440*280 汽车图片493*292 非主流图片381*283 背景图片610*360 游戏原画626*317 萌图315*425 装修设计460*280
</td></tr>
<tr><td width='16%' height=25 bgcolor='ffffff'>首页推荐图</td><td bgcolor='ffffff'><input name="indextj" type="text" id="indextj" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[indextj]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=indextj<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 385*285 
</td></tr>
<tr><td width='16%' height=25 bgcolor='ffffff'>栏目推荐图1</td><td bgcolor='ffffff'><input name="re1" type="text" id="re1" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[re1]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=re1<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 搞笑频道190*120 美食图片240*160 动漫图片190*140 纹身图片190*170
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>栏目推荐图2</td><td bgcolor='ffffff'><input name="re2" type="text" id="re2" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[re2]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=re2<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 搞笑频道190*210 美食图片236*320 动漫图片180*285 纹身图片370*350
</td></tr>

<tr><td width='16%' height=25 bgcolor='ffffff'>图片小图</td><td bgcolor='ffffff'><input name="titlepic" type="text" id="titlepic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[titlepic]))?>" size="45">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>图片简介</td><td bgcolor='ffffff'><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picsay]))?></textarea>
</td></tr></table>