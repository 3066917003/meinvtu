...
<link href="/css/article_articleV2.css" type="text/css" rel="stylesheet" />
...
?>
    ...
    <div class="articleV2TypeList">
      <ul class="TxtList">
<?php include(ECMS_PATH.'/html/isgood.html');?>
    ...
    <div class="articleV2TypeList">
      <ul class="starList">
<?php include(ECMS_PATH.'/html/rmmx.html');?>
      </ul>
    </div>
    <div class="hr10"></div>
...
<?
if ($classid==3){
$sql='select tagid,tagname from www_92game_net_enewstags where cid in(1,2) order by tagid desc limit 20';
}
if ($classid==4){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=4 order by tagid desc limit 20';
}
if ($classid==5){
$sql='select tagid,tagname from www_92game_net_enewstags where cid in(5,6,7,12,13,14) order by tagid desc limit 20';
}
if ($classid==7){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=10 order by tagid desc limit 20';
}
if ($classid==12){
$sql='select tagid,tagname from www_92game_net_enewstags where cid in(15,16,17) order by tagid desc limit 20';
}
if ($classid==13){
$sql='select tagid,tagname from www_92game_net_enewstags where cid in(15,16,17) order by tagid desc limit 20';
}
if ($classid==17){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=26 order by tagid desc limit 20';
}
if ($classid==20){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=25 order by tagid desc limit 20';
}
if ($classid==22){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=21 order by tagid desc limit 20';
}
if ($classid==23){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=23 order by tagid desc limit 20';
}
if ($classid==25){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=22 order by tagid desc limit 20';
}
if ($classid==26){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=24 order by tagid desc limit 20';
}
if ($classid==30){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=28 order by tagid desc limit 20';
}
if ($classid==31){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=29 order by tagid desc limit 20';
}
if ($classid==33){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=21 order by tagid desc limit 20';
}
if ($classid==34){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=3 order by tagid desc limit 20';
}
if ($classid==35){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=20 order by tagid desc limit 20';
}
if ($classid==36){
$sql='select tagid,tagname from www_92game_net_enewstags where cid=11 order by tagid desc limit 20';
}
if (!$sql){
$sql='select tagid,tagname from www_92game_net_enewstags order by tagid desc limit 20';
}
...
<?php include(ECMS_PATH.'/html/jczt.html');?>
